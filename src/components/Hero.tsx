        ...
        <section className="h-[69vh] md:h-screen grid place-items-center px-4">
          <h1 className="uppercase text-center leading-[1]">
            <span
              ...
              className="text-transparent text-4xl sm:text-6xl lg:text-8xl font-bold tracking-tight"
            >
              markdown
            </span>
            <br></br>
            <span
              ...
              className="font-extrabold text-5xl sm:text-7xl lg:text-[9rem] tracking-wider"
            >
              copilot ai
            </span>
            <br></br>
            ...
            }} className="text-4xl md:text-9xl sm:text-6xl tracking-wide font-medium">post</span>
          </h1>
        </section>
      </>
    );
